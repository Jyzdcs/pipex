...
/*   Updated: 2025/03/07 01:06:23 by kclaudan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
pid_t		create_process_1(t_cmd *cmd, char *env[], int pipefd[2],
				int input_fd);
pid_t		create_process_2(t_cmd *cmd, char *env[], int pipefd[2],
				int output_fd);
